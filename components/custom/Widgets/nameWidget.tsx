    ...
    return ( 
         <div className='group h-[130px] sm:h-[170px] flex bg-black bg-opacity-10 backdrop-blur-[100px] rounded-2xl p-4 text-white items-center ' >
            <Image
                ...
                className="object-cover rounded-[130px] w-[100px] h-[100px] sm:w-[139px] sm:h-[139px] opacity-80 group-hover:opacity-100 duration-500"
                width={139}
                height={139}
                alt="Pranav"
            />
            <div className="px-5 w-full flex flex-col justify-center">
              <p className="text-4xl sm:text-5xl opacity-80 font-medium group-hover:opacity-100 duration-500 text-start">
