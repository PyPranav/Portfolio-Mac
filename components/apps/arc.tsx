...
const ArcPage = ({ CloseApp, openedApp, appStates, setAppStates }: { CloseApp: (appNum: number) => void, openedApp: number, appStates: any, setAppStates: any }) => {
            ...
            <TabsList className="flex flex-col h-full p-2 pt-0 items-start justify-start bg-[#292929] bg-opacity-0 overflow-hidden">
                    ...
                    <p className=" cursor-pointer truncate text-xs my-2 w-full rounded-xl  bg-white bg-opacity-10 px-4 py-3 text-white text-opacity-60 select-none" title="Copy URL" onClick={()=>{
                        ...
                        toast({
                            ...
                            duration: 1000,
                            className:'rounded-xl w-fit fixed top-8 right-8 p-3 bg-gray-500 text-white border-0'
